    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_image', models.ImageField(upload_to='temp/', verbose_name='Pasport rasmi (yoki ID card)')),
                ('id_card_back_photo', models.ImageField(upload_to='temp/', verbose_name='ID card orqa tomon rasmi')),
